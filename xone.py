...
pyinstaller xone.py -i app.ico --hidden-import docx --hidden-import pynput --add-data "msg1.wav;." --add-data  "title.ico;." --add-data  "query.png;." --add-data "msg2.wav;." --add-data  "close.gif;."
